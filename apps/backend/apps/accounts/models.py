...
class Staff(AbstractBaseUser, PermissionsMixin):
    ...
    can_correct_header_fields = models.BooleanField(default=False)
    can_correct_rates_discounts = models.BooleanField(default=False)
    can_correct_quantities = models.BooleanField(default=False)
    can_correct_customer = models.BooleanField(default=False)
    can_modify_bill_with_return = models.BooleanField(default=False)
