...
@unittest.skip("Signals removed in V2")
class SignalCRUDTests(TestCase):
    ...
    def test_invoice_create_logged(self):
        ...
        invoice = SaleInvoice.objects.create(outlet=self.outlet, customer=customer, invoice_no='INV-001', grand_total=Decimal('100.00'), subtotal=Decimal('100.00'), taxable_amount=Decimal('100.00'), amount_paid=Decimal('0.00'), invoice_date=timezone.now().date(), billed_by=self.staff)
    ...
    def test_invoice_update_logged(self):
        customer = Customer.objects.create(name='Cust', phone='1111111111', outlet=self.outlet)
        invoice = SaleInvoice.objects.create(outlet=self.outlet, customer=customer, invoice_no='INV-002', grand_total=Decimal('100.00'), subtotal=Decimal('100.00'), taxable_amount=Decimal('100.00'), amount_paid=Decimal('0.00'), invoice_date=timezone.now().date(), billed_by=self.staff)
    ...
    def test_invoice_cancel_logged_as_cancelled(self):
        customer = Customer.objects.create(name='Cust', phone='1111111111', outlet=self.outlet)
        invoice = SaleInvoice.objects.create(outlet=self.outlet, customer=customer, invoice_no='INV-003', grand_total=Decimal('100.00'), subtotal=Decimal('100.00'), taxable_amount=Decimal('100.00'), amount_paid=Decimal('0.00'), invoice_date=timezone.now().date(), billed_by=self.staff)
        from apps.audit.services import log_activity
        log_activity(action='INVOICE_CANCELLED', module='billing', entity_type='SaleInvoice', entity_id=invoice.id, user=self.staff)
    ...
    def test_purchase_invoice_create_logged(self):
        ...
        invoice = PurchaseInvoice.objects.create(outlet=self.outlet, distributor=distributor, invoice_no='PINV-001', invoice_date=timezone.now().date(), subtotal=Decimal('500.00'), taxable_amount=Decimal('500.00'), grand_total=Decimal('500.00'), created_by=self.staff)
    ...
    def test_purchase_invoice_update_logged(self):
        distributor = Distributor.objects.create(name='Dist', outlet=self.outlet, phone='123')
        invoice = PurchaseInvoice.objects.create(outlet=self.outlet, distributor=distributor, invoice_no='PINV-002', invoice_date=timezone.now().date(), subtotal=Decimal('500.00'), taxable_amount=Decimal('500.00'), grand_total=Decimal('500.00'), created_by=self.staff)
    ...
    def test_customer_create_logged(self):
        cust = Customer.objects.create(outlet=self.outlet, name='John Doe', phone='9000000000')
