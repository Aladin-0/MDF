...
class DiffEngineTests(TestCase):
    ...
    def test_flat_voucher_diff(self):
        old_snap = {'total_amount': '200.00', 'narration': 'old text', 'updated_at': '2024-01-01T00:00:00Z'}
        new_snap = {'total_amount': '300.00', 'narration': 'new text', 'updated_at': '2024-01-02T00:00:00Z'}
    ...
    def test_nested_invoice_diff(self):
        old_snap = {'header': {'status': 'draft'}, 'financial': {'subtotal': '10.00'}, 'items': [{'id': 'item1', 'product_name': 'Paracetamol', 'qty': 1, 'total_amount': '10.00'}]}
        new_snap = {'header': {'status': 'applied'}, 'financial': {'subtotal': '20.00'}, 'items': [{'id': 'item1', 'product_name': 'Paracetamol', 'qty': 2, 'total_amount': '20.00'}]}
