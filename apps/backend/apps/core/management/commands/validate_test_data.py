...
# TODO(Phase 3): Re-enable once GSTR builders are implemented
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        seeded_sales_snapshots = GSTTransactionSnapshot.objects.filter(document_number__startswith=PREFIX, transaction_type='sale').count()
        ...
        seeded_ret_snapshots = GSTTransactionSnapshot.objects.filter(document_number__startswith=PREFIX, transaction_type='sales_return').count()
        ...
        if not outlet_mh:
            ...
            elif anchor_inv_1.cgst != Decimal('6.00') or anchor_inv_1.sgst != Decimal('6.00'):
            ...
            elif anchor_inv_2.igst != Decimal('24.00'):
            ...
            elif anchor_pur_1.gst_amount != Decimal('60.00'):
