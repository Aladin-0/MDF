...
def test_purchase_edit_concurrency():
    ...
    payload1 = {'outletId': str(outlet.id), 'distributorId': str(distributor.id), 'partyLedgerId': str(distributor_ledger.id), 'invoiceNo': 'INV-CONCURRENCY-1', 'invoiceDate': '2026-08-01', 'revisionReasonCode': 'CORRECTION', 'revisionReasonText': 'Updating quantity to fix mistake', 'subtotal': '200.00', 'discountAmount': '0', 'taxableAmount': '200.00', 'gstAmount': '24.00', 'cessAmount': '0', 'grandTotal': '224.00', 'items': [{'productId': str(product.id), 'batchNo': 'BATCH-CONC', 'expiryDate': '2030-12-31', 'packSize': 10, 'qty': 20, 'actualQty': 20, 'qtyLoose': 0, 'purchaseRate': '10.00', 'ptr': '10.00', 'pts': '10.00', 'mrp': '15.00', 'saleRate': '15.00', 'gstRate': '12.00', 'taxableAmount': '200.00', 'gstAmount': '24.00', 'totalAmount': '224.00'}]}
    payload2 = {'outletId': str(outlet.id), 'distributorId': str(distributor.id), 'partyLedgerId': str(distributor_ledger.id), 'invoiceNo': 'INV-CONCURRENCY-1', 'invoiceDate': '2026-08-01', 'revisionReasonCode': 'CORRECTION', 'revisionReasonText': 'Updating quantity to fix mistake again', 'subtotal': '300.00', 'discountAmount': '0', 'taxableAmount': '300.00', 'gstAmount': '36.00', 'cessAmount': '0', 'grandTotal': '336.00', 'items': [{'productId': str(product.id), 'batchNo': 'BATCH-CONC', 'expiryDate': '2030-12-31', 'packSize': 10, 'qty': 30, 'actualQty': 30, 'qtyLoose': 0, 'purchaseRate': '10.00', 'ptr': '10.00', 'pts': '10.00', 'mrp': '15.00', 'saleRate': '15.00', 'gstRate': '12.00', 'taxableAmount': '300.00', 'gstAmount': '36.00', 'totalAmount': '336.00'}]}
