...
class HeaderCorrectionTestCase(BaseRevisionTestCase):
    ...
    def test_header_correction_on_paid_invoice(self):
        ...
        self.assertEqual(revision.action, 'header_correction')
    ...
    def test_header_correction_cannot_change_total(self):
        ...
        invoice.refresh_from_db()
        self.assertEqual(invoice.grand_total, grand_total_before)
        self.assertEqual(invoice.items.first().qty_strips, 5)