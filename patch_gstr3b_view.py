...
with open('apps/frontend/components/reports/GSTR3BView.tsx', 'r') as f:
    content = f.read()

imports = """import { useGSTR3BReport, useLockGSTReport, useUnlockGSTReport } from '@/hooks/useReports';
import { Lock, Unlock, ShieldCheck, ShieldAlert } from 'lucide-react';
"""

content = content.replace("import { useGSTR3BReport } from '@/hooks/useReports';", imports)

setup = """    const { data, isLoading, error } = useGSTR3BReport(dateRange);
...
"""
content = content.replace("    const { data, isLoading, error } = useGSTR3BReport(dateRange);", setup)
...
with open('apps/frontend/components/reports/GSTR3BView.tsx', 'w') as f:
    f.write(content)
